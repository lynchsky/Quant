...
def init(context):
    """
    双均线系统属于最常用的趋势跟踪类指标。其中短期均线代表短期趋势，长期均线代表长期趋势。短期均线金叉长期均线代表趋势向上的力量较强，为做多信号；短期
    均线死叉长期均线代表趋势向下的力量较强，为做空信号。

    双均线策略常规用法：
    1、短期均线金叉长期均线，开多，如有空单，先平空再开多
    2、短期均线死叉长期均线，开空，如有多单，先平多再开空
